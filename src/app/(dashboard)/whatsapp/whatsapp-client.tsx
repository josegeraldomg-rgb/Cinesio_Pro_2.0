  ...
  return (
    <div className="space-y-0">
      ...
      <div className="bg-white rounded-2xl border border-[#E8E8E8] shadow-sm">
          ...
          {ABAS.map((a) => {
            ...
            return (
              <button
                ...
                `}
              >
                <span className={active ? 'text-[#25D366]' : 'text-[#B0BEC5]'}>
                  {a.icon}
                </span>
                {a.label}
              </button>
        ...
        {/* Conteúdo da aba */}
        <div className="px-6">
          {aba === 'painel'    && <AbasPainel />}
          {aba === 'historico' && <AbasHistorico />}
          {aba === 'templates' && <AbasTemplates />}
          {aba === 'conexao'   && <AbasConexao />}
          {aba === 'agente-ia' && <AbasAgenteIA />}
        </div>
      </div>
    </div>
  )
